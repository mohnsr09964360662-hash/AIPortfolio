const translations = {
    en: {
        ...
        aboutP2: "As an experienced trainer and educator, I have a proven track record in teaching programming, AI concepts, and Lego Robotics (Scratch programming & robot assembly) to youth and university students, blending entrepreneurial thinking with deep technical knowledge to inspire the next generation.",
        statYears: "Years Exp", statProjects: "Major Projects", statStudents: "Students Trained",
        tech: "Tech", stack: "Stack", skillLang: "Languages", skillAI: "AI & Machine Learning", skillDev: "App & Game Dev", skillRobotics: "Robotics & Mentorship",
    ...
    ar: {
        ...
        aboutP2: "كمدرب ومعلم ذو خبرة، لدي سجل حافل في تدريس مفاهيم البرمجة والذكاء الاصطناعي وعلوم الروبوتيك (برمجة Scratch وتركيب روبوتات Lego) للشباب وطلاب الجامعات، حيث أدمج بين التفكير الريادي والمعرفة التقنية العميقة لإلهام جيل الغد من المبتكرين.",
        statYears: "سنوات خبرة", statProjects: "مشاريع ضخمة", statStudents: "طلاب دربتهم",
        tech: "المهارات", stack: "التقنية", skillLang: "لغات البرمجة", skillAI: "الذكاء الاصطناعي", skillDev: "تطوير التطبيقات والألعاب", skillRobotics: "الروبوتيك والتدريب",
